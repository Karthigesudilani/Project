...
<br>
<div class ="container" style="border-style:double; background-color:#A9D0F5;">
...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                        ...
                        $sql = "SELECT * FROM comments WHERE name LIKE '%{$_POST["keyname"]}%' OR comments LIKE '%{$_POST["keyname"]}%'";
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                          echo "<td>"; echo $row['commentsId']; echo "</td>";
