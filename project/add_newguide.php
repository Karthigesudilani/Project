...
<div style="background-color: #E0E6F8; width: 80% ">
  <h1> <u>New Guide Application Details</u> </h1>
          <div class="col-sm-12">
...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              echo "<td>"; echo $row['newGuideId'];  echo "</td>";
                              echo "<td>"; echo $row['nGuideFname'];  echo "</td>";
                              echo "<td>"; echo $row['nGuideLname'];  echo "</td>";
                              ...
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_newguideDelete.php?id={$row["newGuideId"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
