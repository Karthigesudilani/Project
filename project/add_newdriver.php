...
<center><div style="background-color: #E0E6F8; width: 80% ">
  <h1> <u>New Driver Application Dtails</u> </h1>
          <div class="col-sm-12">
...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              echo "<td>"; echo $row['newDriverId'];  echo "</td>";
                              echo "<td>"; echo $row['nDriverFname'];  echo "</td>";
                              echo "<td>"; echo $row['nDriverLname'];  echo "</td>";
                              echo "<td>"; echo $row['nDnic'];  echo "</td>";
                              echo "<td>"; echo $row['nDdob'];  echo "</td>";
                              echo "<td>"; echo $row['nDcontactNo'];  echo "</td>";
                              echo "<td>"; echo $row['nDmail'];  echo "</td>";
                              echo "<td>"; echo $row['nDaddress'];  echo "</td>";
                              
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_newdriverdelete.php?id={$row["newDriverId"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
