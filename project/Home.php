...
<div class="img"><img src="img\van.jpg" width="100%"></div>
</div></div>

  <a class="nav-link" href="Transportation.php"><button type="button" class="btn btn-success" style="align-items: right;"><center>Start Booking For Transport</button></a>
