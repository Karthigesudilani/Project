...
<div class="w3-padding">
     ...
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="dPhoneNo" type="text" placeholder="Driver Phone No"  id="dPhoneNo"></div>   
     <br />
     <div class="w3-padding">
     <input class="w3-input w3-border" name="dAge" type="text" placeholder="Driver Age"  id="dAge"></div>   
     <br />
<div class="w3-padding">
