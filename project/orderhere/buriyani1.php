										...
										<div class="container" style="font-family:navfont; font-color:White;">
											<img src="../Images/logo.png" alt="Dulsara logo">
												<div id="navcontent">
													...
													<a class="navbar-brand" style="color:White;" href="../tableneww.php">Reserve Tables</a>
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="buriyani1.php"</script>';
			}
		}
	}
}
...
?>
		...
		<div class="container">
			...
			<br /><br />
			<?php
				$query = "SELECT * FROM foods where (category_name='Briyani') ORDER BY food_id ASC";
