...
<!--category--> <div class="btn-toolbar">
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="kothu1.php"</script>';
			}
		}
	}
}
...
?>
		...
		<div class="container">
			...
			<br /><br />
			<?php
				$query = "SELECT * FROM foods where (category_name='Kottu Rotti') ORDER BY food_id ASC";
