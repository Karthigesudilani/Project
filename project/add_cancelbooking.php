...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              echo "<td>"; echo $row['canceld'];  echo "</td>";
                              echo "<td>"; echo $row['userMail'];  echo "</td>";
                              echo "<td>"; echo $row['bId'];  echo "</td>";
                              echo "<td>"; echo $row['cancelType'];  echo "</td>";
                              echo "<td>"; echo $row['guideId'];  echo "</td>";
                              echo "<td>"; echo $row['driverId'];  echo "</td>";
                              echo "<td>"; echo $row['userId'];  echo "</td>";
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_cancelbooking_delete.php?id={$row["canceld"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
