...
<div style="width: 80% ">
  <h1> <u>Transport</u> </h1>
          ...
          <br />             
          <div class="col-sm-12">
            <button style="float:right;" class="btn btn-dark" type="button" onClick= "window.location.href ='addnew_tr.php';" ><i class=></i>Add New Trasport</button>
          </div>
                 </td></tr></table>       
          </div>
<br /><br /><br />
              ...
              <table class="table table-striped table-bordered" id="example" style="width: 95%;">
                <thead>
                  <tr>
                    <th>Vehicle ID</th>
                    <th>Vehicle Name</th>
                    <th>How Many People can Tavel</th>
                    <th>Image</th>
                    <th></th>   
                  </tr>
