...
<div style="background-color: #E0E6F8; width: 80% ">
  <h1> <u>Package Booking Details</u> </h1>
          <div class="col-sm-12">
...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              echo "<td>"; echo $row['pBookingId'];  echo "</td>";
                              echo "<td>"; echo $row['fullname'];  echo "</td>";
                              echo "<td>"; echo $row['email'];  echo "</td>";
                              echo "<td>"; echo $row['pakageType'];  echo "</td>";
                              echo "<td>"; echo $row['address'];  echo "</td>";
                              echo "<td>"; echo $row['phoneNum'];  echo "</td>";
                              echo "<td>"; echo $row['startDate'];  echo "</td>";
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_packageDelete.php?id={$row["pBookingId"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
